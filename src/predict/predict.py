from src.training.fusion_global_local import fusion_models
...
gmic.compile(
    ...
    metrics=[
        tf.keras.metrics.BinaryAccuracy(name="accuracy", threshold=0.45),
...
test_loss, test_accuracy, test_auc = gmic.evaluate(test_df)
