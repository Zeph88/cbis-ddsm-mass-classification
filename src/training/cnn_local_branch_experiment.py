...
plt.legend()
plt.grid(True)
plt.savefig(OUTPUT_PLOT / f"val_loss and loss - {PIXELS_H}x{PIXELS_W} - seed {SEED}.png", dpi=300, bbox_inches="tight")
...
plt.legend()
plt.grid(True)
plt.savefig(OUTPUT_PLOT / f"val_auc and auc - {PIXELS_H}x{PIXELS_W} - seed {SEED}.png", dpi=300, bbox_inches="tight")